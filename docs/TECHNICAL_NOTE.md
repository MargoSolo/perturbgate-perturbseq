...
**TargetGate — an evidence-gated pipeline for T-cell Perturb-seq mechanism hypotheses**

TargetGate v1.0.0 (frozen hackathon release, 2026-07-13). Prepared for *Built with Claude: Life Sciences* (Anthropic x Gladstone Institutes), Research track: "Find new drug targets in a T-cell Perturb-seq dataset from the Marson and Pritchard labs."
